...
export type InputFieldNumberState = 'DEFAULT' | 'VALID' | 'ERROR'
...
export const InputFieldNumber: React.FC<InputFieldNumberProps> = (props) => {

    const state = React.useMemo((): InputFieldNumberState => {
        if (props.error) {
            return 'ERROR'
        } else if (props.value) {
            return 'VALID'
...
const styleProcesser = {
    container: (state: InputFieldNumberState): StyleProp<ViewStyle> => ({
